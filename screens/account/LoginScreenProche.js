    ...
    <View style={{flex:0.4,
     ...
     <View style={{ width:adaptToWidth(0.9),flexDirection:'row', justifyContent:'space-around'}}>
         ...
         <View style={{ flex:0.6,justifyContent:'flex-start',alignItems:'center'}}>
          ...
          <TouchableOpacity 
          style={styles.button} onPress = {() => props.navigation.navigate('Home_proche')}>
          ...
          <TouchableOpacity onPress = {() => props.navigation.navigate('Register_proche')}>
...
export default LoginScreenProche
