...
const check = () => {
  ...
  return (
    <SafeAreaView style={{flex:1, alignItems:'center', backgroundColor:colors.primary}}>
      ...
      source={require('../../assets/red.png')} /></View>
<Text style={{fontFamily:'Montserrat', fontSize:20, textAlign:'center',
 paddingVertical:adaptToHeight(0.03)}}>Quel est le nom de cette couleur? Veuillez écrire la bonne réponse</Text>
...
<ModalPoupSucess visible={visible}>
        <View style={{alignItems: 'center'}}>
          <View style={styles.header}>
              <TouchableOpacity navigation={props.navigation}  onPress = {() => props.navigation.navigate('Jeu5')}>
                  <Image
