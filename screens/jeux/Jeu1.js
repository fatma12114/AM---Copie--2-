...
const [visible2, setVisible2] = React.useState(false);
  return (
    <SafeAreaView style={{flex:1, alignItems:'center', backgroundColor:colors.primary}}>
      ...
      source={require('../../assets/Daughter.jpg')} /></View>
...
<Text style={{fontFamily:'Montserrat', fontSize:20  }}>Fatma</Text>
</TouchableOpacity>

<ModalPoupSucess visible={visible}>
        <View style={{alignItems: 'center'}}>
          <View style={styles.header}>
              <TouchableOpacity navigation={props.navigation}  onPress = {() => props.navigation.navigate('Jeu2')}>
                  <Image
...
<Text style={{fontFamily:'Montserrat', fontSize:20  }}>Amira</Text>
</TouchableOpacity>
...
style={{height:adaptToHeight(0.07), width:adaptToWidth(0.7),marginVertical:adaptToHeight(0.01),
 backgroundColor:colors.pastelLightPink, alignItems:'center', justifyContent:'center', borderWidth:1, borderRadius:50}}
 onPress={() => setVisible2(true)}>
<Text style={{fontFamily:'Montserrat', fontSize:20  }}>Ahmed</Text>
</TouchableOpacity>
...
style={{height:adaptToHeight(0.07), width:adaptToWidth(0.7),marginVertical:adaptToHeight(0.01),
 backgroundColor:colors.pastelLightPink, alignItems:'center', justifyContent:'center', borderWidth:1, borderRadius:50}}
 onPress={() => setVisible2(true)}>
<Text style={{fontFamily:'Montserrat', fontSize:20  }}>Zeineb</Text>
</TouchableOpacity>
