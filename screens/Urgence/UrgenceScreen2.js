...
const UrgenceScreen2 = (props) => {
  return (
    <SafeAreaView style={styles.container}>
      <View style={{flex:0.3, justifyContent:'flex-end'}}><Text style={{fontFamily:'Montserrat',fontSize:40,textAlign:'center'}} numberOfLines={3}>
        Voulez-vous notifier vos proches?</Text></View>
      <View style={{flexDirection:'row', justifyContent:'space-around', flex:0.7}}>
          ...
          <TouchableOpacity style={styles.TouchableOpacity2}><Text style={styles.text} 
           onPress = {() => props.navigation.navigate('Urgence3')}>OUI</Text></TouchableOpacity>
      </View>
    </SafeAreaView>
  )
}

export default UrgenceScreen2
